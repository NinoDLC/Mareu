...
public abstract class DummyMeetingRoomsGenerator {
    ...
    private static final List<MeetingRoom> DUMMY_MEETING_ROOMS = Arrays.asList(
            new MeetingRoom(1, "Braque-de-Weimar", "1st floor, 1st door on the left", generateDevices(), 3),
            new MeetingRoom(2, "Doberman", "1st floor, 2nd door on the left", generateDevices(), 4),
            new MeetingRoom(3, "Dogue-Allemand", "1st floor, 1st door on the right", generateDevices(), 5),
            new MeetingRoom(4, "Caniche", "1st floor, 2nd door on the right", generateDevices(), 2),
            new MeetingRoom(5, "Jack-Russel", "2nd floor, 1st door on the left", generateDevices(), 4),
            new MeetingRoom(6, "Fox-Terrier", "2nd floor, 2nd door on the left", generateDevices(), 5),
            new MeetingRoom(7, "Labrador", "2nd floor, 1st door on the right", generateDevices(), 2),
